...
Online documentation, which includes examples, can be found at: http://godoc.org/github.com/talkincode/go-telnet

[![GoDoc](https://godoc.org/github.com/talkincode/go-telnet?status.svg)](https://godoc.org/github.com/talkincode/go-telnet)
...
A more useful TELNET servers can be made using the `"github.com/talkincode/go-telnet/telsh"` sub-package.
...
TELNET servers made using the `"github.com/talkincode/go-telnet/telsh"` sub-package will often be more useful
as it makes it easier for you to create a *shell* interface.


# More Information

There is a lot more information about documentation on all this here: http://godoc.org/github.com/talkincode/go-telnet
